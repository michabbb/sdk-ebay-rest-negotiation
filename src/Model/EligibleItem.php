...
class EligibleItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets listingId
     *
     * @param string|null $listingId The unique eBay-assigned ID for an eBay listing.  <br><br>A <b>listingId</b> is assigned by eBay when a seller creates a listing with the Trading API.
     *
     * @return self
     */
